...
class  List {
    ...
    public:
        ...
        /**
         * @brief insert - 	¬ставл€ет элементы
        ...
        void splice(Iterator pos, Iterator first, Iterator last) {
            //если накос€чить то образуетс€ петл€
            //но мы же все знаем топовые алгоритмы дл€ того чтоб пон€ть попали мы в неЄ иль нет
            //так шо € оставлю все на кодера который будет писать код
            //и назову ето неопределенным поведением // Ёту хуйню сказал пидор
            
            //сохран€ем указатель дл€ дальнейших действий
